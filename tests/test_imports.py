...
def test_config_compat_constants():
    ...
    from vx.config import (  # noqa: F401
...
def test_fan_module_imports():
    ...
    from vx.fan import read_state, compute_fan_speed  # noqa: F401
    from vx.fan import (  # noqa: F401
...
def test_serve_module_imports():
    from vx.serve import start_vllm, stop_vllm, is_vllm_running  # noqa: F401
    assert callable(start_vllm)
    assert callable(is_vllm_running)


def test_models_module_imports():
    from vx.models import scan_models, fuzzy_match, detect_model, ModelInfo  # noqa: F401
